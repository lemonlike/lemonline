...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(verbose_name=u"性别", max_length=7, choices=(("male", u"男"), ("female", u"女")),
                              default="female")
    ...
    def unread_nums(self):
        ...
        return UserMessage.objects.filter(name=self.id).count()
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name=u"验证码类型",
                                 choices=(("register", u"注册"), ("forget", u"忘记密码"),
